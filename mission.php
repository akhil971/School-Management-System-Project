                        ...
                        <div class="col-md-6">
                         ...
                         <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <br><button type="submit"name="addmission"class="btn btn-success">
                                 save
                                </button>
                            </div>
                         </div>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="editmission.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-success">Edit</a>
                                                            <a href="deletedata.php?missionId=<?php echo $row['id']; ?>"  class="btn btn-sm btn-danger">Delete</a>
                                                        </td>
                                                    </tr>
                                                <?php  }  ?>
                                            </tbody>
