                                    ...
                                    <div class="table-responsive">
                                        <table class="table data-table stripe hover nowrap table-bordered table-striped" id="myTable">
                                            ...
                                            <tbody>
                                               ...
                                               $sql = "SELECT * FROM tbl_payment WHERE status IN ('1', '2')";
                                               ...
                                               ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <button type="submit" name="approvepayment" class="btn btn-sm btn-success" style="color:white;">Approve</button>
                                                         ...
                                                         <td>
                                                            <a href="action.php?deletepaymenthistory&id=<?php echo $row['id']; ?>" onclick="return confirm('Sure! you want to delete');" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
                                                        </td>
                                                    </tr>
                                                <?php  }  ?>
                                            </tbody>
