                                        ...
                                        <table class="table data-table stripe hover nowrap table-bordered table-striped" id="myTable">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        <td><?= $sn; ?></td>
                                                        <td><img src="<?php echo 'http://localhost/irin/greenfield_db/admin/uploads/abc/' . trim($row['image']) ?>" alt="" style="width:100px; height:100px;"></td>
                                                        <td><?= $row['heading']; ?></td>
                                                        <td><?= $row['content']; ?></td>

                                                        <td>
                                                            <a href="deletedata.php?delete_gallery=<?php echo $row['id']; ?>" class="btn btn-sm btn-success">DELETE</a>
                                                            <!-- <form action="admin/action.php" method="GET"> -->
                                                            
                                                            <a href="editgallery.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning">EDIT</a>
                                                            <!-- <form action="admin/action.php" method="GET"> -->
